...
image_path = "static/images/others/productsimage.jpg"

image_base64 = encode_image(image_path)

api_key = "fw_3Zdt6zcipcaFcGkBDZLGj6DR"
...
# Format the assistant content as plain text
formatted_response = assistant_content.replace("**", "")
